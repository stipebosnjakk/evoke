...
INSERT INTO `__new_list_order`("scope_id", "task_id", "area_id", "project_id", "section_id", "order_key", "created_at", "updated_at") SELECT "scope_id", "task_id", "area_id", "project_id", "section_id", "order_key", "created_at", "updated_at" FROM `list_order`;--> statement-breakpoint
